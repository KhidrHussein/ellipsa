 ...
 * @param mainWindow The main browser window for sending IPC messages
 */
export function stopAudioCapture(mainWindow: BrowserWindow | null): void {
 ...
 * @param mainWindow The main browser window for sending IPC messages
 */
async function processAudioSegment(chunks: Blob[], mainWindow: BrowserWindow | null): Promise<void> {
  ...
  const filePath: string = join(getAudioDir(), filename);
 ...
 * @param mainWindow The main browser window for sending IPC messages
 */
function cleanupAudio(mainWindow: BrowserWindow | null): void {
  try {
