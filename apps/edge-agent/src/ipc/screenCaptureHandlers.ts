...
import { ScreenCapture, CaptureResult } from '../capture/screenCapture';
...
export class ScreenCaptureHandlers {
  ...
  private setupHandlers() {
    ...
    ipcMain.handle('start-screen-capture', async (_, interval: number = 5000) => {
    ...
    ipcMain.handle('capture-active-window', async (): Promise<CaptureResult | null> => {
