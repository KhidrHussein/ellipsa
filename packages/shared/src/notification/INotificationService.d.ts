export type NotificationType = 'email' | 'email:received' | 'email:action-required' | 'draft:ready' | 'error' | 'reminder' | 'system' | 'alert' | 'draft_response';
...
export declare const NOTIFICATION_CHANNEL = "notification";
